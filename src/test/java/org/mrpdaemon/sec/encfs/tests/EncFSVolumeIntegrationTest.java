...
public class EncFSVolumeIntegrationTest {
  ...
  public static byte[] readInputStreamAsByteArray(EncFSFile encFSFile)
    ...
    EncFSUtil.copyWholeStreamFinallyCloseInput(new EncFSFileInputStream(encFSFile), buf);
    EncFSUtil.copyWholeStreamFinallyCloseInput(new EncFSFileInputStream(encFSFile), buf);
