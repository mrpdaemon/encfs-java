...
public class EncFSFileInfo {
   ...
   * @param parentPath   Volume path of the parent directory hosting the file
   * @param directory    Whether the file is a directory
   * @param lastModified Last modification time of the file
   * @param size         Raw size of the underlying file
   ...
   * by this object
   *
   * @param volume            Volume hosting this file
   * @param decodedParentPath Decoded path of the parent directory for the output file
   * @param decodedFileName   Decoded file name of the output file
