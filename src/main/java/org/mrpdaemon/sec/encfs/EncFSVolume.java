...
public class EncFSVolume {
   ...
   * @throws EncFSInvalidPasswordException Given password is incorrect
   * @throws EncFSCorruptDataException     Corrupt data detected (checksum error)
   * @throws EncFSInvalidConfigException   Configuration file format not recognized
   * @throws EncFSUnsupportedException     Unsupported EncFS version or options
   ...
   * @param rootPath    Path of the root directory of the EncFS volume on the local
   *                    filesystem
   * @param passwordKey Cached password-based key/IV data. Can be obtained using
   ...
   * @throws EncFSCorruptDataException Corrupt data detected (checksum error)
   * @throws EncFSChecksumException    Corrupt data detected (checksum error)
   * @throws IOException               File provider returned I/O error
   */
   ...
   * @throws EncFSCorruptDataException Filename encoding failed
   * @throws EncFSChecksumException    Filename encoding failed
   * @throws IOException               File provider returned I/O error
   */
   ...
   * @throws EncFSCorruptDataException Filename encoding failed
   * @throws EncFSUnsupportedException File header uses an unsupported IV length
   * @throws IOException               File provider returned I/O error
   */
