...
public class EncFSLocalFileProvider implements EncFSFileProvider {
   ...
   * @throws IOException Source file/dir doesn't exist or misc. I/O error
   */
   ...
   * @throws IOException Misc. I/O error
   */
   ...
   * @param srcPath Path of the file or directory
   * @return EncFSFileInfo for the given file or directory
   * @throws IOException Path doesn't exist or misc. I/O error
   */
   ...
   * @throws IOException Path not a directory or misc. I/O error
   */
   ...
   * @throws IOException File already exists or misc. I/O error
   */
   ...
   * @throws IOException Destination file already exists, source file doesn't exist or
   *                     misc. I/O error
   */
   ...
   * @throws IOException Source file doesn't exist or misc. I/O error
   */
